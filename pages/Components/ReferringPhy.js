            ...
            <div className='bg-white h-screen flex flex-col'>
                ...
                <div className='flex-1 flex items-center'>
                    <div className='w-2/3 h-full overflow-auto'>
                        <form className="bg-white p-8 rounded-lg shadow-lg"  action='/doRefer'>
                            <h2 className="text-3xl font-bold mb-6 text-indigo-500">Referring A Doctor</h2>
                            <div className="grid grid-cols-2 gap-6">
                                <CustomInput type='text' id='title' title='Title' placeholder="e.g. Mr, Mrs, Ms" />
                                <CustomInput type='text' id='firstName' title='Patient First Name' placeholder="Enter your first name" />
                                <CustomInput type='text' id='lastName' title='Patient Last Name' placeholder="Enter your last name" />
                                ...
                                <CustomInput type='text' id='text' title='Your Designation' placeholder="Enter your name with Designation" />
                                <CustomInput type='text' id='doctor' title = 'Doctor' placeholder='Doctor to be referred'/>
                            </div>
                            <button type="submit" className="bg-indigo-500 text-white font-bold py-2 px-4 rounded-lg mt-8 hover:bg-indigo-600">Done</button>
                        </form>
                    </div>
                    <div className='w-1/3 h-full bg-white overflow-auto pt-[10%] text-gray-700'>
                        <p className="text-lg leading-relaxed">
                            {"  Thank you for referring a doctor through Nearmed. We greatly appreciate your trust in our services. Rest assured that we will take good care of your patient and provide them with the medical assistance they need."}
                        </p>
                        <p className="mt-4">
                            {" At Nearmed, we believe that every referral can make a difference. Your support enables us to continue our mission of providing affordable medical care to underserved communities. Together, we can make a positive impact on people's lives."}
                        </p>
                    </div>
                </div>
            </div>
